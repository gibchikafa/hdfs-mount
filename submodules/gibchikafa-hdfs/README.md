...
[![GoDoc](https://godoc.org/github.com/gibchikafa/hdfs/web?status.svg)](https://godoc.org/github.com/gibchikafa/hdfs) [![build](https://travis-ci.org/gibchikafa/hdfs.svg?branch=master)](https://travis-ci.org/gibchikafa/hdfs)
...
To install the library, once you have Go [all set up][2]:
    ...
    $ go get -u github.com/gibchikafa/hdfs

Installing the commandline client
---------------------------------

Grab a tarball from the [releases page](https://github.com/gibchikafa/hdfs/releases)
...
[1]: https://godoc.org/github.com/gibchikafa/hdfs
